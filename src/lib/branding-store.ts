// Branding & theme preset store — localStorage-based
...
export function saveBranding(patch: Partial<BrandingConfig>) {
...
export const themePresets: ThemePreset[] = [
  {
    ...
    light: {}, // empty = use index.css defaults
    dark: {},
  },
  {
    id: "emerald",
    ...
    light: {
      ...
      "--ring": "155 80% 38%",
      "--sidebar-primary": "155 80% 38%",
      "--sidebar-primary-foreground": "0 0% 100%",
      "--sidebar-ring": "155 80% 38%",
    ...
    dark: {
      ...
      "--ring": "155 80% 48%",
      "--sidebar-primary": "155 80% 48%",
      "--sidebar-primary-foreground": "160 20% 7%",
      "--sidebar-ring": "155 80% 48%",
  ...
  },
  {
    ...
    dark: {
      ...
      "--sidebar-primary-foreground": "30 20% 7%",
  ...
  },
  {
    ...
    dark: {
      ...
      "--accent-foreground": "210 20% 95%",
      "--ring": "270 70% 62%",
      "--sidebar-primary": "270 70% 62%",
      "--sidebar-primary-foreground": "270 20% 7%",
      "--sidebar-ring": "270 70% 62%",
  ...
  },
  {
    ...
    light: {
      ...
      "--accent-foreground": "0 0% 100%",
      "--ring": "345 75% 55%",
      "--sidebar-primary": "345 75% 55%",
      "--sidebar-primary-foreground": "0 0% 100%",
      "--sidebar-ring": "345 75% 55%",
      "--chart-forwarded": "345 75% 55%",
    },
    dark: {
      "--primary": "345 75% 60%",
      "--primary-foreground": "340 20% 7%",
      "--accent": "340 65% 55%",
      "--accent-foreground": "210 20% 95%",
      "--ring": "345 75% 60%",
      "--sidebar-primary": "345 75% 60%",
      "--sidebar-primary-foreground": "340 20% 7%",
      "--sidebar-ring": "345 75% 60%",
  ...
  },
  {
    ...
    dark: {
      ...
      "--sidebar-primary-foreground": "215 20% 7%",
  ...
  },
  {
    ...
    light: {
      ...
      "--accent-foreground": "0 0% 100%",
      "--ring": "5 70% 45%",
      "--sidebar-primary": "5 70% 45%",
      "--sidebar-primary-foreground": "0 0% 100%",
      "--sidebar-ring": "5 70% 45%",
    ...
    dark: {
      ...
      "--accent-foreground": "210 20% 95%",
      "--ring": "5 70% 52%",
      "--sidebar-primary": "5 70% 52%",
      "--sidebar-primary-foreground": "5 20% 7%",
      "--sidebar-ring": "5 70% 52%",
